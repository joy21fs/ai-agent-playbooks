...
ai-agent-playbooks/
├── job-search-agent/
│   ├── instructions.md     # Full agent task specification
...
- Prompt engineering for agentic, multi-step browser tasks
- Structured output design (scoring rubrics, tabular data, section templates)
- Multi-platform data retrieval with fallback handling
- Real-world automation without code: pure LLM + browser
